...
export function Story() {
  ...
  useEffect(() => {
    ...
    const exists = favoriteStories.some(
  ...
  useEffect(() => {
    ...
    localStorage.setItem(
      ...
      JSON.stringify(favoriteStories)
    );
  }, [isFavorite, selectedStory, username]);
    ...
    <main id="read-page">
      ...
      <section id="story">
        <header id="storyTitle">
          <b>
            <u>{selectedStory.title}</u>
          </b>
        </header>
        <p id="username">
          <i>by {selectedStory.author}</i>
        </p>
