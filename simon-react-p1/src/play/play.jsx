    ...
    <main className="bg-secondary">
        <div className="players">
          ...
          <div id="player-messages">
            <div className="event"><span class="player-event">Linus</span> scored 377</div>
            <div className="event"><span class="player-event">Linus</span> started a new game</div>
            <div className="event"><span class="system-event">game</span> connected</div>
          </div>
        </div>
